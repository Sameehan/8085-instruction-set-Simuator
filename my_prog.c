...
INT8U my_prog[32]=
{
         0x21,0x00,0xc1,      //C000          LXI     H,C100H
         0x06,0x20,           //C003          MVI     B,20H
         0x0e,0x00,           //C005          MVI     C,00H
         MOV_A_M,             //C007  LOOP:   MOV     A,M
         0xfe,0x55,           //C008          CPI     55H
         0xc2,0x0e,0xc0,      //C00A          JNZ     SKIP
         0x0c,                //C00D          INR     C
         0x23,                //C00E  SKIP:   INX     H
         0x05,                //C00F          DCR     B
         0xc2,0x07,0xc0,      //C010          JNZ     LOOP
         0x79,                //C013          MOV     A,C
         0x32,0x20,0xc1,      //C014          STA     C120H
         0x76                 //C017          HLT
};
...
INT8U my_data[32]=
{
         ...
         0x01,0x02,0x54,0x04,0x01,0x02,0x55,0x04,
	     0x01,0x02,0x55,0x04,0x01,0x02,0x56,0x04,
	     0x01,0x02,0x00,0x04,0x01,0x02,0x55,0x04
};
